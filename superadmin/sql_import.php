...
('Burfee Cart 2', 'member2@example.com', '9876543211', 'EMP100000');" class="w-full bg-obsidian/80 border border-neon-cyan/30 rounded-xl p-3 text-xs text-ice font-mono focus:outline-none focus:border-neon-cyan"></textarea>
        ...
        <div class="space-y-6">
            ...
            <div class="glass-card p-6 rounded-3xl border border-red-500/30 space-y-3 bg-red-950/10">
                ...
                <p class="text-[11px] text-ice/70 leading-relaxed">
                    Wipe all customer members, matrix nodes, transactions, and wallets to start a 100% fresh copy with 0 members. Only Root <code class="text-neon-cyan font-mono">EMP100000</code> and Admin accounts will remain.
                </p>
