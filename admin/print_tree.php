...
<body class="custom-scrollbar">
    ...
    <header class="mb-6 p-4 bg-gray-900 text-white rounded-2xl shadow-md no-print flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-xl bg-amber-500 text-gray-900 flex items-center justify-center font-black text-xl">
                E3
            </div>
            <div>
                <h1 class="text-lg font-black tracking-wide text-amber-400">EMPRESS TWO WAY 3.0</h1>
                <p class="text-xs text-gray-300">4-Level Matrix Printable Structure Console</p>
            </div>
        </div>

        <div class="flex flex-wrap items-center gap-3">
            <form action="print_tree.php" method="GET" class="flex gap-2">
                <input type="text" name="member_id" value="<?php echo htmlspecialchars($targetId); ?>" placeholder="Member ID" class="bg-gray-800 border border-gray-700 rounded-xl px-3 py-1.5 text-xs text-amber-300 uppercase font-mono focus:outline-none focus:border-amber-400">
                <button type="submit" class="bg-amber-500 hover:bg-amber-400 text-gray-900 font-bold px-3.5 py-1.5 rounded-xl text-xs transition">
                    Inspect
                </button>
            </form>
