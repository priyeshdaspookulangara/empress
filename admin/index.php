...
<div class="space-y-8">
    ...
    <div class="glass-card p-6 rounded-3xl border border-neon-cyan/30 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2 text-xs">
            <a href="/admin/members.php" class="neon-button px-3.5 py-2 rounded-xl flex items-center gap-1.5">
                <i class="fa-solid fa-users"></i> Members
            </a>
            <a href="/admin/matrix_tree.php" class="glass-card border border-neon-cyan/30 hover:bg-neon-cyan/10 text-neon-cyan px-3.5 py-2 rounded-xl flex items-center gap-1.5">
                <i class="fa-solid fa-sitemap"></i> Matrix Tree
            </a>
            <a href="/admin/kyc.php" class="glass-card border border-neon-cyan/30 hover:bg-neon-cyan/10 text-neon-cyan px-3.5 py-2 rounded-xl flex items-center gap-1.5 relative">
            ...
            <a href="/admin/epins.php" class="glass-card border border-neon-cyan/30 hover:bg-neon-cyan/10 text-neon-cyan px-3.5 py-2 rounded-xl flex items-center gap-1.5">
                <i class="fa-solid fa-key"></i> ePINs
            </a>
            <a href="/admin/wallet.php" class="glass-card border border-neon-cyan/30 hover:bg-neon-cyan/10 text-neon-cyan px-3.5 py-2 rounded-xl flex items-center gap-1.5">
                <i class="fa-solid fa-money-bill-transfer"></i> Payouts
            </a>
            <a href="/admin/financials.php" class="glass-card border border-neon-cyan/30 hover:bg-neon-cyan/10 text-neon-cyan px-3.5 py-2 rounded-xl flex items-center gap-1.5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="glass-card p-6 rounded-3xl border border-amber-500/40 bg-amber-500/5">
            ...
            <p class="text-[11px] text-ice/50 mt-2"><a href="/admin/kyc.php" class="text-neon-cyan underline">Inspect pending KYC applications</a></p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="glass-card p-6 rounded-3xl border border-neon-cyan/20 flex flex-col justify-between">
            ...
            <a href="/admin/epins.php" class="neon-button py-2.5 rounded-xl text-xs text-center font-bold">
        ...
        <div class="glass-card p-6 rounded-3xl border border-neon-cyan/20 flex flex-col justify-between">
            ...
            <a href="/admin/matrix_tree.php" class="glass-card border border-neon-cyan/40 hover:bg-neon-cyan/10 text-neon-cyan py-2.5 rounded-xl text-xs text-center font-bold">
                Open Tree Inspector
            </a>
        </div>
    ...
    <div class="glass-card p-6 rounded-3xl border border-neon-cyan/20">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="/admin/members.php" class="text-xs text-neon-cyan hover:underline font-bold">View All Members →</a>
        </div>
