                            ...
                            <tr>
                                ...
                                <td class="p-3 font-mono max-w-xs">
                                    ...
                                    <?php if (!empty($m['qr_code_url'])): ?>
                                        <div class="mt-1">
                                            <a href="<?php echo htmlspecialchars($m['qr_code_url']); ?>" target="_blank" class="text-gold text-[10px] underline flex items-center gap-1">
                                ...
                                <td class="p-3">
                                    <form action="/admin/kyc.php" method="POST" class="flex gap-2">
